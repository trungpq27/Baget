...
class InsertTransactionsUseCase @Inject constructor(private val repo: TransactionRepository) {
    suspend operator fun invoke(transactions: List<TransactionDto>) {
        repo.insertTransactions(transactions)
    }
}
